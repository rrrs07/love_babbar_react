...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://sheet.best/api/sheets/9c589295-2e64-48ca-a013-200cacb82722', form)
            .then((response) => {
            ...
            <div className="contact__container container grid">
                <div className="contact__content">
                    ...
                    <div className="contact__card">
                        ...
                        <p className="contact__card-data">rohitrrrs1234@gmail.com</p>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <p className="contact__card-data">+916287537894</p>
                    </div>
                </div>
