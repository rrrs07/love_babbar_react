  ...
  return (
    <div>
        ...
        className='flex bg-slate-700 p-1 gap-x-1 my-6 rounded-full max-w-max'>
            ...
            :"bg-transparent text-orange-200"} py-2 px-5 rounded-full transition-all duration-200`}
        ...
        <button className=' w-full bg-yellow-500 rounded-[8px] font-medium text-slate-900 px-[12px] py-[8px] mt-6'>
            Create Account
        </button>
        </form>
